...
public class SidebarConsultaCINEX extends JPanel {
    ...
    public SidebarConsultaCINEX(int pasoActivo) {
    ...
    private class ItemPaso extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            int fontSize = activo ? 14 : 13;
            g2.setFont(new Font("Arial", Font.BOLD, fontSize));

            FontMetrics fm = g2.getFontMetrics();
            int xTexto = 18;
            int yTexto = (alto - fm.getHeight()) / 2 + fm.getAscent();
            String textoFinal = ajustarTexto(g2, texto, cuerpoAncho - 30);
